...
export const CONTROL_TOOLS = [
    {
        name: "pi_get_state",
        description: "Get the state of the Pi Browser integration: connection status, the known Pi sessions " +
    ...
    {
        name: "pi_new_session",
        description: "Create a new Pi session (ACP session/new) with the given working directory. " +
    ...
    },
    {
        ...
        description: "Make a Pi session the active one in the Firefox sidebar. Loads (or re-resumes) its " +
    ...
    {
        name: "pi_prompt",
        description: "Send a prompt to a Pi session (ACP session/prompt). Returns immediately with " +
    ...
    },
    {
        ...
        description: "Set a session config option (ACP session/set_config_option), e.g. configId \"model\" or " +
    ...
    },
    {
        ...
        description: "Bind the currently active Firefox tab to a Pi session. After this, the session's " +
    ...
    },
    {
        ...
        description: "Activate the tab bound to a Pi session (focus its window and make the tab visible). " +
...
export function getControlTool(name) {
    return TOOL_BY_NAME.get(name);
}
export function isControlTool(name) {
    return TOOL_BY_NAME.has(name);
}
export function isMutatingControlTool(name) {
