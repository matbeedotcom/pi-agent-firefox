...
export const BROWSER_TOOLS = [
    {
        ...
        description: "Get basic information about the page in the Firefox tab bound to this session: URL, title, and viewport size.",
        inputSchema: { ...OBJECT_SCHEMA_BASE, properties: {} },
        readOnly: true,
    },
    {
        name: "browser_get_selection",
        description: "Get the current text selection in the bound tab. Returns empty text when nothing is selected.",
        inputSchema: { ...OBJECT_SCHEMA_BASE, properties: {} },
        readOnly: true,
    },
    {
        name: "browser_get_dom",
        description: "Get a compact semantic representation of the page in the bound tab with stable element references (ref). " +
    ...
    },
    {
        ...
        description: "Capture a screenshot of the bound tab as an image. Returns image data the agent can see.",
        inputSchema: {
            ...OBJECT_SCHEMA_BASE,
            properties: {
                format: {
    ...
    {
        name: "browser_click",
        description: "Click an element referenced by a stable ref from browser_get_dom in the bound tab. " +
    ...
    {
        name: "browser_type",
        description: "Type text into an element referenced by a stable ref from browser_get_dom in the bound tab. " +
    ...
    },
    {
        ...
        description: "Wait in the bound tab until a CSS selector matches (or stops matching) or a timeout elapses. " +
...
export function getBrowserTool(name) {
